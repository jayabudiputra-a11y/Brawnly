...
/* ============================================================
   JSON-LD constants — built outside component to avoid
   re-serialising on every render
   ============================================================ */
...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      {/* ── Microdata: header-level ── */}
      <meta itemProp="url" content={SITE_URL} />
      <meta itemProp="name" content={SITE_NAME} />
      <meta itemProp="description" content={SITE_DESCRIPTION} />

      {/* ── SEO HIDDEN: full site identity + nav for crawlers ── */}
      <div
        aria-hidden="true"
        style={{
          position: "absolute",
      ...
      {/* ── Rainbow accent bar (existing, aria-hidden preserved) ── */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 relative">
        ...
        {/* ── Mobile menu (existing logic preserved) ── */}
        {isOpen && (
          <div id="mobile-menu">
