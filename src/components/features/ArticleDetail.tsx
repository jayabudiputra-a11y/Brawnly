          ...
          <article className="flex-1 relative min-w-0">
            ...
            <div className="mb-12 md:mb-16 relative overflow-hidden group rounded-2xl md:rounded-3xl border-2 border-black dark:border-white shadow-2xl">
              {_isVid ? (
                ...
                <div className={`relative transition-all duration-700 ${_blobUrl ? 'blur-0' : 'blur-xl'}`}>
                  <ArticleCoverImage
            ...
            <div className="max-w-[840px] mx-auto">
              ...
              {_imgL.slice(1).length > 0 && (
                <div className="my-16 md:my-20 bg-neutral-50 dark:bg-[#111] border-l-[12px] md:border-l-[16px] border-emerald-600 p-6 md:p-8 rounded-r-3xl">
